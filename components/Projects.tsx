  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        <div className="pt-6">{project.description}</div>
      </CardContent>
...
const projects: ProjectData[] = [
  {
    ...
    description:
      "A CLI tool written in TypeScript with the oclif CLI library designed to generate CRUD operations for TypeScript projects using Supabase. This tool streamlines development by automating repetitive database tasks, making integration with Supabase seamless for developers.",
    technologies: [
      {
  ...
  },
  {
    ...
    company: "Personal Project",
    description:
      "A full-stack web application built with Next.js and TypeScript that enables users to document and manage their travel experiences. The platform features a modern, responsive interface styled with Tailwind CSS and integrates with Supabase for secure user authentication and real-time data storage.",
  ...
  },
  {
    ...
    description:
      "A full stack web app made as my second Capstone designed to help small business owners track customers and any invoices those customers have, as well as a calendar to track upcoming events.  The app is complete with both Google OAuth and standard email auth.",
    technologies: [
      {
        imageUrl: `${techUrl}NextJsLogo.png`,
        alt: "Next",
...
const Projects = () => {
  return (
    <div className="relative max-w-7xl py-10 px-5 mx-auto">
